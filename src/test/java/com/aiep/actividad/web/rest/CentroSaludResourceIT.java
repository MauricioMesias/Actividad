...
import static com.aiep.actividad.domain.CentroSaludAsserts.*;
...
import com.aiep.actividad.repository.CentroSaludRepository;
...
class CentroSaludResourceIT {
    ...
    private static final String DEFAULT_TIPOCENTRO = "AAAAAAAAAA";
    private static final String UPDATED_TIPOCENTRO = "BBBBBBBBBB";
    ...
    public static CentroSalud createEntity() {
        return new CentroSalud().nombre(DEFAULT_NOMBRE).tipocentro(DEFAULT_TIPOCENTRO).direccion(DEFAULT_DIRECCION);
    }
    ...
    public static CentroSalud createUpdatedEntity() {
        return new CentroSalud().nombre(UPDATED_NOMBRE).tipocentro(UPDATED_TIPOCENTRO).direccion(UPDATED_DIRECCION);
    }
    ...
    @Test
    @Transactional
    void checkTipocentroIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        centroSalud.setTipocentro(null);
    ...
    void getAllCentroSaluds() throws Exception {
        ...
        restCentroSaludMockMvc
            ...
            .andExpect(jsonPath("$.[*].tipocentro").value(hasItem(DEFAULT_TIPOCENTRO)))
    ...
    void getCentroSalud() throws Exception {
        ...
        restCentroSaludMockMvc
            ...
            .andExpect(jsonPath("$.tipocentro").value(DEFAULT_TIPOCENTRO))
    ...
    void putExistingCentroSalud() throws Exception {
        ...
        updatedCentroSalud.nombre(UPDATED_NOMBRE).tipocentro(UPDATED_TIPOCENTRO).direccion(UPDATED_DIRECCION);
    ...
    void partialUpdateCentroSaludWithPatch() throws Exception {
        ...
        partialUpdatedCentroSalud.direccion(UPDATED_DIRECCION);
    ...
    void fullUpdateCentroSaludWithPatch() throws Exception {
        ...
        partialUpdatedCentroSalud.nombre(UPDATED_NOMBRE).tipocentro(UPDATED_TIPOCENTRO).direccion(UPDATED_DIRECCION);
