...
/**
 * REST controller for managing {@link com.aiep.actividad.domain.Medico}.
 */
@RestController
...
public class MedicoResource {
    ...
    public ResponseEntity<Medico> partialUpdateMedico(
        ...
        Optional<Medico> result = medicoRepository
            ...
            .map(existingMedico -> {
                if (medico.getRut() != null) {
                    existingMedico.setRut(medico.getRut());
                }
                if (medico.getNombre() != null) {
                    existingMedico.setNombre(medico.getNombre());
                }
                if (medico.getaPaterno() != null) {
                    existingMedico.setaPaterno(medico.getaPaterno());
                }
                if (medico.getaMaterno() != null) {
                    existingMedico.setaMaterno(medico.getaMaterno());
                }
