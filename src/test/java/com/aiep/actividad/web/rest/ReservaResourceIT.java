...
import static com.aiep.actividad.domain.ReservaAsserts.*;
import static com.aiep.actividad.web.rest.TestUtil.createUpdateProxyForBean;
import static com.aiep.actividad.web.rest.TestUtil.sameInstant;
...
class ReservaResourceIT {
    ...
    public static Reserva createEntity() {
        return new Reserva().fechaHora(DEFAULT_FECHA_HORA).motivo(DEFAULT_MOTIVO);
    }
    ...
    public static Reserva createUpdatedEntity() {
        return new Reserva().fechaHora(UPDATED_FECHA_HORA).motivo(UPDATED_MOTIVO);
    }
    ...
    void putExistingReserva() throws Exception {
        ...
        updatedReserva.fechaHora(UPDATED_FECHA_HORA).motivo(UPDATED_MOTIVO);
    ...
    void partialUpdateReservaWithPatch() throws Exception {
        ...
        partialUpdatedReserva.fechaHora(UPDATED_FECHA_HORA);
    ...
    void fullUpdateReservaWithPatch() throws Exception {
        ...
        partialUpdatedReserva.fechaHora(UPDATED_FECHA_HORA).motivo(UPDATED_MOTIVO);
