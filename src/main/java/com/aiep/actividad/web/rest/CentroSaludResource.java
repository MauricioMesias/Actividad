...
/**
 * REST controller for managing {@link com.aiep.actividad.domain.CentroSalud}.
 */
@RestController
    ...
    public ResponseEntity<CentroSalud> partialUpdateCentroSalud(
        ...
        Optional<CentroSalud> result = centroSaludRepository
            ...
            .map(existingCentroSalud -> {
                ...
                if (centroSalud.getTipocentro() != null) {
                    existingCentroSalud.setTipocentro(centroSalud.getTipocentro());
                }
