...
describe('Reserva Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Paciente query and add missing value', () => {
      ...
      const paciente: IPaciente = { id: 16133 };
      reserva.paciente = paciente;

      const pacienteCollection: IPaciente[] = [{ id: 27268 }];
    ...
    it('Should call Medico query and add missing value', () => {
      const reserva: IReserva = { id: 456 };
      const medico: IMedico = { id: 22516 };
      reserva.medico = medico;

      const medicoCollection: IMedico[] = [{ id: 14562 }];
    ...
    it('Should call CentroSalud query and add missing value', () => {
      const reserva: IReserva = { id: 456 };
      const centroSalud: ICentroSalud = { id: 17664 };
      reserva.centroSalud = centroSalud;

      const centroSaludCollection: ICentroSalud[] = [{ id: 31594 }];
    ...
    it('Should update editForm', () => {
      const reserva: IReserva = { id: 456 };
      const paciente: IPaciente = { id: 9934 };
      reserva.paciente = paciente;
      const medico: IMedico = { id: 6915 };
      reserva.medico = medico;
      const centroSalud: ICentroSalud = { id: 9984 };
      reserva.centroSalud = centroSalud;
