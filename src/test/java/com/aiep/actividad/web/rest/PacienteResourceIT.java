...
import static com.aiep.actividad.domain.PacienteAsserts.*;
...
class PacienteResourceIT {
    ...
    void partialUpdatePacienteWithPatch() throws Exception {
        ...
        partialUpdatedPaciente.rut(UPDATED_RUT).nombre(UPDATED_NOMBRE).aMaterno(UPDATED_A_MATERNO);
