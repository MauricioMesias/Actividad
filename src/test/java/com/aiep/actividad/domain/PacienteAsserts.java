...
public class PacienteAsserts {
    ...
    public static void assertPacienteUpdatableFieldsEquals(Paciente expected, Paciente actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getaPaterno()).as("check aPaterno").isEqualTo(actual.getaPaterno()))
            .satisfies(e -> assertThat(e.getaMaterno()).as("check aMaterno").isEqualTo(actual.getaMaterno()))
