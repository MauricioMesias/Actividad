...
import com.aiep.actividad.domain.Paciente;
import com.aiep.actividad.repository.PacienteRepository;
...
/**
 * REST controller for managing {@link com.aiep.actividad.domain.Paciente}.
 */
@RestController
    ...
    public ResponseEntity<Paciente> partialUpdatePaciente(
        ...
        Optional<Paciente> result = pacienteRepository
            ...
            .map(existingPaciente -> {
                ...
                if (paciente.getaPaterno() != null) {
                    existingPaciente.setaPaterno(paciente.getaPaterno());
                }
                if (paciente.getaMaterno() != null) {
                    existingPaciente.setaMaterno(paciente.getaMaterno());
                }
